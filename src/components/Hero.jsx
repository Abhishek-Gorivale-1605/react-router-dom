        ...
        <div class="font-sans max-w-6xl max-md:max-w-md mx-auto">
            <div class="grid md:grid-cols-2 items-center md:gap-8 gap-6">
                ...
                <div class="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute before:bg-[#DEE2E5] before:h-[120%] before:w-[120%] before:right-0 before:z-0">
                    <img src="https://imgs.search.brave.com/s6wNAr1hEZOzDU0UzjsweBEApJTq9wPPTJHZ9W-HfOc/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMTE0/NDU0NTMzNC9waG90/by93b21hbi1pbi1i/dXNpbmVzcy1vZmZp/Y2UuanBnP3M9NjEy/eDYxMiZ3PTAmaz0y/MCZjPWF3ZGZBbjZX/anA3SFFXbzhmYWhC/VUVnY2hNNF9vVzcz/SENzNzMwM3RWZjA9" class="rounded-md lg:w-4/5 z-50 relative" alt="Dining Experience" />
                </div>
            </div>
